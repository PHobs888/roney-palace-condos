...
<div className="hero">
  ...
  <div className="hero-content">
    ...
    <div className="hero-buttons">
      <a href="#sale" className="btn-primary">Condos for Sale</a>
      <a href="#rent" className="btn-secondary">Condos for Rent</a>
    </div>
  </div>
</div>
      ...
      <section className="about" id="info">
        ...
        <p>
          ...
          located directly on the sand and sharing amenities with the world-class 1 Hotel.
          With short-term rental flexibility (30 days), strong investor demand,
          and resort-style amenities, the building attracts both luxury buyers
          and high-yield short-term rental investors.
        </p>
      </section>
      ...
      <section className="sale-section" id="sale">
        ...
        <p className="section-note">
          MLS listings will appear here automatically once your IDX access is activated.
        </p>
...
<section className="contact" id="contact">
  ...
  <p className="contact-intro">
    Interested in buying, renting, or investing at Roney Palace?
    Contact me anytime — I respond quickly.
  </p>
  ...
  <div className="contact-card">
    ...
    <h3>Paul H.</h3>
    <p className="contact-title">Real Estate Advisor · Coldwell Banker Realty</p>

    <p className="contact-row">
      <span className="icon">📧</span>
      <a href="mailto:info@roneypalacecondos.com">info@roneypalacecondos.com</a>
    </p>
...
<footer className="footer">
  <div className="footer-container">
    ...
    <p className="footer-brand">RoneyPalaceCondos.com</p>
